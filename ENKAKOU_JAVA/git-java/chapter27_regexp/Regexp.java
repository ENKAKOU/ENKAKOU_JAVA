...
//        String content = "《沉香如屑》是由郭虎 、任海涛执导，杨紫、成毅领衔主演，张睿、孟子义、朱泳腾、" +
//                "徐恺咛、李欣泽、韩承羽、傅方俊、 李彧、朱丽岚、沈晓海、林源、叶晞月、谷雪儿主演，何中华、" +
//                "侯梦瑶、孙泽源、杨肸子特别出演的古装爱情仙侠剧。\n" +
//                "该剧改编自苏寞的同名小说，讲述了菡萏仙子颜淡与六界帝君应渊联手向恶势力宣战，在相知相识中逐渐解开以往的误会，" +
//                "最终携手维护人间正道、共同守护天下苍生的曲折故事。\n" +
//                "系列剧《沉香如屑·沉香重华》分为上下两部，" +
//                "上部《沉香如屑》于2022年7月20日在优酷独播，" +
//                "下部《沉香重华》于2022年8月18日在优酷独播。" +
//                "该剧于2022年12月28日在安徽卫视上星播出 。";
...
//                "    </div>";
        ...
        //传统方式：使用遍历方式，代码量大，效率不高。
        //正则表达式技术

        //1.先创建一个Pattern对象，模式对象（就是一个正则表达式对象）
